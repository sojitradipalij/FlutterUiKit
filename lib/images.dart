class Images {
  ///----------------- Brand -----------------------------------//
  static String brandLogo = 'assets/brandImg/flutteruikit.png';
  ...
  static String appIcon = 'assets/icons/all_apps.svg';
  ...
  static String shoppingBannerPhoto =
      'assets/images/all_apps/shopping_app/images/cover_poster_3.jpg';
  static String shoppingOrderSuccess =
      'assets/images/all_apps/shopping_app/images/order_success.png';
  static String shoppingSplash =
      'assets/images/all_apps/shopping_app/images/splash.png';
  static String apple = 'assets/images/all_apps/shopping_app/icons/apple.png';
  static String google = 'assets/images/all_apps/shopping_app/icons/google.png';
  static String facebook = 'assets/images/all_apps/shopping_app/icons/facebook.png';
  static String shoppingProfile =
      'assets/images/all_apps/shopping_app/images/profile.jpg';
  static String discountBubble =
      'assets/images/all_apps/shopping_app/icons/discount_bubble_outline.png';
  static String discountCoupon =
      'assets/images/all_apps/shopping_app/icons/discount_coupon_outline.png';
  static String discountCircle =
      'assets/images/all_apps/shopping_app/icons/discount_circle_outline.png';

  //---------------------- Learning ------------------------------------//

  static String learningProfile1 =
      'assets/images/all_apps/learning/images/profile1.jpg';
  static String learningProfile2 =
      'assets/images/all_apps/learning/images/profile2.jpg';
  static String learningProfile3 =
      'assets/images/all_apps/learning/images/profile3.jpg';
  static String learningProfile4 =
      'assets/images/all_apps/learning/images/profile4.jpg';
  static String learningProfile5 =
      'assets/images/all_apps/learning/images/profile5.jpg';
  static String learningProfile =
      'assets/images/all_apps/learning/images/profile.jpg';
  static String document1 = 'assets/images/all_apps/learning/icons/document_1.png';
  static String document2 = 'assets/images/all_apps/learning/icons/document_2.png';
  static String document3 = 'assets/images/all_apps/learning/icons/document_3.png';
  static String student = 'assets/images/all_apps/learning/icons/student.png';
  static String teacher = 'assets/images/all_apps/learning/icons/teacher.png';
  static String learningSplash =
      'assets/images/all_apps/learning/images/splash.png';
  static String forgotPassword =
      'assets/images/all_apps/learning/icons/forgot_password.png';
  static String courseBanner =
      'assets/images/all_apps/learning/images/course_photo.png';

  //---------------------- Fitness ------------------------------------//

  static String fitnessProfile =
      'assets/images/all_apps/fitness_app/images/profile.jpg';
  static String skipping = 'assets/images/all_apps/fitness_app/images/skipping.png';
  static String running = 'assets/images/all_apps/fitness_app/images/running.png';
  static String yoga = 'assets/images/all_apps/fitness_app/images/yoga.png';
  static String fitnessLogIn = 'assets/images/all_apps/fitness_app/images/login.png';
  static String fitnessRegister =
      'assets/images/all_apps/fitness_app/images/register.png';
  static String fitnessForgotPassword =
      'assets/images/all_apps/fitness_app/images/forgot_password.png';
  static String fitnessResetPassword =
      'assets/images/all_apps/fitness_app/images/reset_password.png';
  static String fitnessSplash = 'assets/images/all_apps/fitness_app/images/splash.png';

  //---------------------- Food ------------------------------------//

  static String foodBanner = 'assets/images/all_apps/foodImg/images/food_banner.jpg';
  static String masterCard = 'assets/images/brandImg/master_card.png';
  static String foodProfile = 'assets/images/all_apps/foodImg/images/profile.jpg';
  static String foodSplash = 'assets/images/all_apps/foodImg/images/splash.png';
  static String foodOrderSuccess =
      'assets/images/all_apps/foodImg/images/order_success.png';
  static String foodAuthentication = 'assets/images/all_apps/foodImg/icons/food.png';
  static String foodMap = 'assets/images/all_apps/foodImg/images/map.png';

  //---------------------- Medical ------------------------------------//

  static String medicalProfile =
      'assets/images/all_apps/medical/images/profile.jpg';
}
