class Showcase {
  ...
  static List<Showcase> getList() {
    return [
      Showcase(
          "./assets/images/all_apps/cookify_app/dish-2.jpg",
          "Cacoa Maca Walnut Milk",
          "Easy, quick and yet so delicious!",
          100,
          50,
          2),
      Showcase("./assets/images/all_apps/cookify_app/dish-3.jpg", "Danish Pecun",
          "Typical winter pastries", 189, 30, 1),
      Showcase("./assets/images/all_apps/cookify_app/dish-4.jpg", "Maple Syrup Buns",
