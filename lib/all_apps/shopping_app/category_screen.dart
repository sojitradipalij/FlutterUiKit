  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            singleCategory(
                image: './assets/images/all_apps/shopping_app/technology.jpg',
                title: "Technology",
                description: '241 Item'),
            FxSpacing.height(16),
            singleCategory(
                image: './assets/images/all_apps/shopping_app/lifestyle.jpg',
                title: "Life Style",
                description: '325 Item'),
            FxSpacing.height(16),
            singleCategory(
                image: './assets/images/all_apps/shopping_app/fashion.jpg',
                title: "Fashion",
                description: '784 Item'),
            FxSpacing.height(16),
            singleCategory(
                image: './assets/images/all_apps/shopping_app/art.jpg',
                title: "Art",
