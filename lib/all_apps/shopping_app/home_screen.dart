            ...
            child: Row(
              children: <Widget>[
                ...
                FxContainer(
                  ...
                  child: Image(
                    image: AssetImage(
                        './assets/images/all_apps/shopping_app/product/product-8.jpg'),
                    width: 125,
                    height: 125,
                  ),
                )
              ...
              children: <Widget>[
                Container(
                  ...
                  child: singleItemWidget(
                      image:
                          './assets/images/all_apps/shopping_app/product/product-10.jpg',
                      name: "Pop corn",
                      rate: 45.99),
                ),
                Container(
                  ...
                  child: singleItemWidget(
                      image:
                          './assets/images/all_apps/shopping_app/product/product-7.jpg',
                      name: "Cosmic bang",
                      rate: 78.99),
                ),
                Container(
                  ...
                  child: singleItemWidget(
                      image:
                          './assets/images/all_apps/shopping_app/product/product-5.jpg',
                      name: "Sweet Gems",
                      rate: 35.99),
                ),
                Container(
                  ...
                  child: singleItemWidget(
                      image:
                          './assets/images/all_apps/shopping_app/product/product-2.jpg',
                      name: "Toffees",
                      rate: 28.49),
                ),
                Container(
                  ...
                  child: singleItemWidget(
                      image:
                          './assets/images/all_apps/shopping_app/product/product-3.jpg',
                      name: "Candies",
                      rate: 15.99),
                ),
              ],
              ...
              children: <Widget>[
                ...
                Container(
                  child: singleForYouWidget(
                    name: "Lipsticks",
                    image:
                        './assets/images/all_apps/shopping_app/product/product-4.jpg',
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          FxSpacing.height(24),
          singleNotification(
              image: './assets/images/all_apps/grocery_app/product-5.png',
              text: RichText(
          ...
          FxSpacing.height(24),
          singleNotification(
              image: './assets/images/all_apps/grocery_app/product-2.png',
              text: RichText(
                text: TextSpan(children: <TextSpan>[
                  TextSpan(
                      text: "30% OFF ",
          ...
          FxSpacing.height(24),
          singleNotification(
              image: './assets/images/all_apps/grocery_app/product-3.png',
              text: FxText.button(
          ...
          FxSpacing.height(24),
          singleNotification(
              image: './assets/images/all_apps/grocery_app/profile.png',
