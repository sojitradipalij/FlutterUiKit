  ...
  static List<Product> getList() {
    return [
      Product("Orange Fresh Juice", Generator.getDummyText(8),
          "./assets/images/all_apps/grocery_app/product-2.png", 59.99, 49.99),
      Product("Fresh Carrot", Generator.getDummyText(8),
          "./assets/images/all_apps/grocery_app/product-5.png", 19.99, 19.99),
      Product("Juicy Grapes", Generator.getDummyText(8),
          "./assets/images/all_apps/grocery_app/product-3.png", 35, 35),
      Product("Green Broccoli", Generator.getDummyText(8),
          "./assets/images/all_apps/grocery_app/product-1.png", 39.99, 29.99),
      Product("Cauliflower", Generator.getDummyText(8),
          "./assets/images/all_apps/grocery_app/product-4.png", 25, 25),
    ];
  }
}
