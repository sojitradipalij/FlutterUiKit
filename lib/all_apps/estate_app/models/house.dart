...
class House {
  ...
  static List<House> houseList() {
    ...
    list.add(House(
        'Duplex Home',
        'assets/images/all_apps/estate_app/estate7.jpg',
    ...
    list.add(House(
        'Bluish Homie',
        'assets/images/all_apps/estate_app/estate4.jpg',
    ...
    list.add(House(
        'Black Modern House',
        'assets/images/all_apps/estate_app/estate6.jpg',
    ...
    list.add(House(
        'Central Edmon',
        'assets/images/all_apps/estate_app/estate2.jpg',
  ...
  static House getOne() {
    return House(
        'Black Modern House',
        'assets/images/all_apps/estate_app/estate1.jpg',
        'New York Street, 1260',
        '\$2000/month',
        '4 Bedrooms',
        '2 Bathrooms',
