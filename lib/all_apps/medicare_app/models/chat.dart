class Chat {
  ...
  static List<Chat> chatList() {
    ...
    list.add(
      Chat('assets/images/profile/avatar_2.jpg', 'Dr. Elizabeth Scott',
          'Thank you for visiting', '05:25 pm', '2', true),
    );
    list.add(
      Chat('assets/images/profile/avatar_3.jpg', 'Dr. Miguel Johnson',
          'What was your last meal?', '12:32 am', '1', false),
    );
    list.add(
      Chat('assets/images/profile/avatar_2.jpg', 'Dr. Sarah Palson',
          'I have a bad headache', '07:56 am', '2', true),
    );
    list.add(
      Chat('assets/images/profile/avatar_2.jpg', 'Dr. Jon Snow',
          'Hello, how can i help you?', '16:45 am', '2', true),
    );
