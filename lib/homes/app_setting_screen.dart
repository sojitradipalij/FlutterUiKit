import 'package:flutteruikit/homes/select_language_dialog.dart';
...
class _AppSettingScreenState extends State<AppSettingScreen> {
  ...
  void launchCodecanyonURL() async {
    String url = "https://1.envato.market/flutteruikit";
    await launch(url);
  }

  void launchDocumentation() async {
    String url = "https://flutteruikit.coderthemes.com/index.html";
    await launch(url);
  }

  void launchChangeLog() async {
    String url = "https://flutteruikit.coderthemes.com/changlog.html";
    await launch(url);
  }
