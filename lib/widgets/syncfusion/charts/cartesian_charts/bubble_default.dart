...
class _BubbleDefaultState extends State<BubbleDefault> {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Container(height: 320, child: _buildDefaultBubbleChart()),
    );
  }
  ...
  SfCartesianChart _buildDefaultBubbleChart() {
    return SfCartesianChart(
        ...
        primaryXAxis: NumericAxis(
            ...
            title: AxisTitle(
                text: 'Literacy rate', textStyle: FxTextStyle.caption()),
            minimum: 60,
            maximum: 100),
        primaryYAxis: NumericAxis(
            ...
            title: AxisTitle(
                text: 'GDP growth rate', textStyle: FxTextStyle.caption())),
