    ...
    return Card(
      ...
      child: Container(
        child: Column(
          ...
          children: <Widget>[
            Image(
              image: AssetImage("./assets/images/all_apps/hotel/room-1.jpg"),
              height: 180,
    ...
    return Card(
      ...
      child: Container(
        child: Column(
          ...
          children: <Widget>[
            Image(
              image: AssetImage("./assets/images/all_apps/hotel/room-2.jpg"),
              height: 180,
              width: MediaQuery.of(context).size.width,
              fit: BoxFit.fill,
            ),
    ...
    return Card(
      ...
      child: Container(
        child: Column(
          ...
          children: <Widget>[
            Image(
              image: AssetImage("./assets/images/all_apps/hotel/room-3.jpg"),
              height: 180,
              width: MediaQuery.of(context).size.width,
              fit: BoxFit.fill,
            ),
