      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: Wrap(
            ...
            children: <Widget>[
              _SingleShowWidget(
                image: './assets/images/all_apps/music/podcast-1.jpg',
                text: "UX",
                height: MediaQuery.of(context).size.width * 0.5 - 30,
              ),
              _SingleShowWidget(
                image: './assets/images/all_apps/music/podcast-2.jpg',
                text: "Corona",
                height: MediaQuery.of(context).size.width * 0.5 - 30,
              ),
              _SingleShowWidget(
                image: './assets/images/all_apps/music/podcast-3.jpg',
                text: "Design Studio",
                height: MediaQuery.of(context).size.width * 0.5 - 30,
              ),
              _SingleShowWidget(
                image: './assets/images/all_apps/music/podcast-4.jpg',
                text: "From Temple",
                height: MediaQuery.of(context).size.width * 0.5 - 30,
              ),
            ],
