...
import 'package:flutteruikit/screens/hotel_screen/hotel_review_screen.dart';
              ...
              child: PageView(
                ...
                children: <Widget>[
                  Container(
                    child: Image(
                      image:
                          AssetImage('./assets/images/all_apps/hotel/room-1.jpg'),
                      height: MediaQuery.of(context).size.height / 3,
                  ...
                  Container(
                    child: Image(
                      image:
                          AssetImage('./assets/images/all_apps/hotel/room-2.jpg'),
                      height: MediaQuery.of(context).size.height / 3,
                      width: MediaQuery.of(context).size.width,
                      fit: BoxFit.fill,
                    ),
                  ...
                  Container(
                    child: Image(
                      image:
                          AssetImage('./assets/images/all_apps/hotel/room-3.jpg'),
                      height: MediaQuery.of(context).size.height / 3,
                      width: MediaQuery.of(context).size.width,
                      fit: BoxFit.fill,
                    ),
