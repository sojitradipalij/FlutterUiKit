            ...
            children: <Widget>[
              ...
              Container(
                child: ClipRRect(
                  borderRadius: BorderRadius.all(Radius.circular(4)),
                  child: Image(
                    image: AssetImage('./assets/images/all_apps/foodImg/food-9.jpg'),
                    width: 125,
                    height: 125,
                  ),
                ),
              ...
              children: <Widget>[
                Container(
                  ...
                  child: singleCategory(
                      image: './assets/images/all_apps/foodImg/food-5.jpg',
                      title: "Chinese"),
                ),
                Container(
                  margin: EdgeInsets.only(left: 20),
                  child: singleCategory(
                      image: './assets/images/all_apps/foodImg/food-6.jpg',
                      title: "Italian"),
                ),
                Container(
                  margin: EdgeInsets.only(left: 20),
                  child: singleCategory(
                      image: './assets/images/all_apps/foodImg/food-7.jpg',
                      title: "American"),
                ),
                Container(
                  margin: EdgeInsets.only(left: 20, right: 20),
                  child: singleCategory(
                      image: './assets/images/all_apps/foodImg/food-8.jpg',
                      title: "Punjabi"),
                ),
              ],
            ),
  ...
  Widget singleNotification(
    ...
    return Container(
      ...
      decoration: BoxDecoration(color: theme.backgroundColor, boxShadow: [
        BoxShadow(
            color: theme.cardTheme.color!.withAlpha(12),
            blurRadius: 8,
            offset: Offset(0, 4))
      ]),
      child: Row(
